...
const ItemStack = ({ img, alt, name, description }) => {
  return (
    <div className="w-full h-20 p-4 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 flex items-center space-x-4 hover:bg-gray-200">
